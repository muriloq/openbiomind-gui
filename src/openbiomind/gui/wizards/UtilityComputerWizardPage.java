...
public class UtilityComputerWizardPage extends AbstractTaskWizardPage implements IWizardPage {
   ...
   private void createRequiredGroup(final Composite parent) {
      ...
      WidgetHelper.createNewDetailsLabel(parent, WizardMessages.UtilityComputerWizardPage_Detail_OutputFile,
            NUM_COLUMN_IN_GROUP);
      // - File name
      ...
      WidgetHelper.createNewFieldLabel(parent, WizardMessages.UtilityComputerWizardPage_Label_OutputFilePath,
            WizardMessages.UtilityComputerWizardPage_Detail_OutputFilePath);
      this.outputFilePathText = createOutputFilePathText(parent);
   }

   /**
    * Creates the result directory text button composite.
    *
    * @param parent the parent
    *
    * @return the text button composite
    */
   private TextButtonComposite createResultDirTBC(final Composite parent) {
      ...
      textButtonComposite.addModifyListenerOnTextField(new ModifyListener() {
         ...
         public void modifyText(final ModifyEvent event) {
            final File directory = new File(getResultDir());
            textButtonComposite
   ...
   private Text createOutputFileDestFileText(final Composite parent) {
      ...
      text.setToolTipText(WizardMessages.UtilityComputerWizardPage_Detail_OutputFile);
   ...
   public String getResultDir() {
      return getResultDirTBC().getText();
   }

   /**
    * Gets the result directory text button composite.
    *
    * @return the result directory text button composite
    */
   private TextButtonComposite getResultDirTBC() {
      return this.resultDirTBC;
   }
   ...
   protected void validatePage() {
      final boolean valid = isProjectInformationValid() && getResultDirTBC().isValid()
