...
/**
 * The class VisitOpenBiomindHandler is used to open OpenBiomind homepage in external browser.
 *
 * @author bsanghvi
 * @since Jul 4, 2008
 * @version Jul 4, 2008
   ...
   public Object execute(final ExecutionEvent event) throws ExecutionException {
      if (!Program.launch(Resources.OPENBIOMIND_HOMEPAGE)) {
         MessageDialog.openError(HandlerUtil.getActiveWorkbenchWindowChecked(event).getShell(), Resources.ERROR,
               CommonMessages.Error_UnableToOpen + SPACE + Resources.OPENBIOMIND_HOMEPAGE);
      }
      return null;
   }
